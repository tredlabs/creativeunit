...
<script>
		...
		function Create_Receival(validated)
	{
		...
		var type = document.getElementById("printerytype").value;
		...
		xhttp.send("Query=Add_price&code="+code+"&unit_cost="+unit_cost+"&instock="+instock+"&reorder="+reorder+"&name="+name+"&addtype="+addtype+"&type="+type+"&location="+location);
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Printery Price Listing</h4>
                                </div>
                            </div>
                        </div>
...
require 'db.php';
	...
	$sql = "SELECT *
	FROM price WHERE location='Warehouse1'";
				 ...
				 <select class="form-control" id="plocation" >
                  ...
                  <option value='Warehouse1'>Printery</option>
						...
						<br/>				
							...
							<div id="printery" class="input-group" style="display: block">
										<div class="input-group-addon">
											<span class="glyphicon glyphicon-print"></span> 
										</div>
										<!--input type="checkbox" name="Equipment_checkbox" id="Equipment_checkbox" onChange="Allow_Equipment(this.checked);"-->
										<select class="form-control" id="printerytype" name="type" onChange="">

                        ...
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li id=""><a href= "showinventory.php">Stock Listing</a></li>
                            ...
                            <li class="has_sub">
                                <a href="profile1.php" class="waves-effect waves-primary"><i
...
<div class="card-box" style="overflow-y: auto">
                ...
                <div class="table-responsive">  
                    ...
                    <div id="live_data" style="overflow: hidden"></div>                 
         ...
         <table class="table table-bordered"> 
		  ...
		  <tr>
		   <td></td>  
                ...
                <td id="p1" contenteditable></td>
                <td id="instock" contenteditable></td>  
                <td id="reorderlevel" contenteditable></td> 
      ...
      {  
           $output .= '  
                <tr>  
                     ...
                     <td class="p1" data-id2="'.$row["id"].'"contenteditable>'.$row["p1"].'</td>  
                     <td class="instock" data-id3="'.$row["id"].'"contenteditable>'.$row["instock"].'</td>  
                     <td class="reorderlevel data-id4="'.$row["id"].'"contenteditable>'.$row["reorderlevel"].'</td>  

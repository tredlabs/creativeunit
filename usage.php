                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Internal PO</h4>
                                </div>
                            </div>
                        </div>
     <div class="card-box" >
			...
			<div class="form-group">
				<div class="row col-md-12 custyle">
							...
							<div class="input-group">
									...
									<label for="sel1"></label><select class="form-control" id="location" onchange="loc();"><option value="" hidden selected>Location:</option><option value='Warehouse1'>Printery</option><option value='Warehouse2'>Office</option><option value='Warehouse3'>Events</option></select>

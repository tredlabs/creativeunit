...
<script>
		...
		function Create_Receival(validated)
	{
		...
		var location = document.getElementById("officelocation").value;
		//alert(location)
		...
		xhttp.send("Query=Add_price&code="+code+"&unit_cost="+unit_cost+"&instock="+instock+"&location="+location+"&reorder="+reorder+"&name="+name+"&addtype="+addtype+"&type="+type+"&type1="+type);
	...
	*/
	...
	//	var size = document.getElementById("editsize").value;
		...
		xhttp.open("POST", "php/Query_Manager.php", true);
		xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		xhttp.send("Query=Update_price&ID="+id+"&code="+code+"&unit_cost="+unit_cost+"&name="+name+"&location="+location+"&sale_cost="+sale_cost);
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Office Price Listing</h4>
                                </div>
                            </div>
                        </div>
...
require 'db.php';
	...
	$sql = "SELECT *
	FROM price WHERE location='Warehouse2'";
		...
		if ($result->num_rows > 0)
		{
			...
			while($row = $result->fetch_assoc())
			{
									...
									{$unit_cost="&nbsp;&nbsp;&nbsp;&nbsp;-";;
										  ...
										  <td><b> $"?><?php echo number_format($myNumber,2);"</b></td>
			...
			<div class="form">
				<div class="row col-md-12 custyle">
				 ...
				 <select class="form-control" id="officelocation" >
                  ...
                  <option value='Warehouse2'>Office</option>
               <!--   <option value='Warehouse2'>Office</option>
                  <option value='Warehouse3'>Events</option>-->
...
function myFunction1(location) {
   // location = document.getElementById("location").value;
    ...
    if(location=="Warehouse2"){
    	...
    	document.getElementById('printery').style.display="none";
    	document.getElementById('events').style.display="none";
    }
    
     if(location=="Warehouse1"){
     	
    	document.getElementById('printery').style.display="block";
    	document.getElementById('events').style.display="none";
...
$db_servername = "localhost";
		...
		$db_name =  "dert1_creative_unit";
													...
													$sql = "SELECT id, name FROM office_type";
													$formatted_result="";
									...
									<div class="input-group">
										...
										<input class="form-control" id="add_type" name="add_number" type="text" placeholder="Add Type" required/>
									</div>

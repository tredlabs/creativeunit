                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Office Receivals</h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="try" class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive"  style="overflow-x:hidden">
                                    ...
                                    <h4 class="m-t-0 header-title"><b>Office Receivals</b></h4>
...
require 'db.php';
	...
	WHERE rec_lineitems.location='Warehouse2' ";
		...
		<form id="Create_ID" data-toggle="validator" role="form" class=""  autocomplete="off">
			<div class="form">
				<div class="row col-md-12 custyle">
									...
									<label for="sel1"></label><select class="form-control" id="location"><option value='Warehouse2'>Office</option></select>
									<div class="help-block with-errors"></div>

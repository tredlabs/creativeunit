...
function Rtest() //This is the function to remove the receivals for the Receival Tabel
                ...
                <div class="content">
                  ...
                  <div class="row">
                        ...
                        <div class="row" id="paper" style="visibility: visible">
                          		<p class="text-muted text-nowrap">Paper</p>
						  ...
						  for($count=0;$count<$limit;$count++){
						  	echo "    <div class='col-sm-6 col-lg-3'>
                                ...
                                <div class='widget-simple-chart text-right card-box'>
                                    <div class='circliful-chart' data-dimension='90' data-text='Paper' data-width='5' data-fontsize='14' data-percent='100' data-fgcolor='#f76397' data-bgcolor='#ebeff2'></div>
                                    <h3 class='text-pink'><span class='counter'> $instock[$count]</span></h3>
                                    <p class='text-black '><b>$item[$count]</b></p>
                                </div>
                            </div>";
	...
	<div class="row">
							<div class="col-sm-12">
								<div class="card-box">
									<h4 class="m-t-0 m-b-20 header-title"><b>Envelopes</b></h4>
   ...
   var historicalBarChart = [{
        ...
        values: [{
            'label':'<?php
             ...
             echo " $envitem[0]";?>',
            'value': <?php echo "$envinstock[0]";?>,
            'color': '#00b19d'
        }, {
            'label':'<?php echo " $envitem[1]";?>',
            'value': <?php echo "$envinstock[1]";?>,
            'color': '#ef5350'
        }, {
            'label':'<?php echo " $envitem[2]";?>',
            'value': <?php echo "$envinstock[2]";?>,
            'color': '#3DDCF7'
        }, {
            'label':'<?php echo " $envitem[3]";?>',
            'value': <?php echo "$envinstock[3]";?>,
            'color': '#ffaa00'
        }, {
           'label':'<?php echo " $envitem[4]";?>',
            'value': <?php echo "$envinstock[4]";?>,
            'color': '#81c868'
        }, {
            'label':'<?php echo " $envitem[5]";?>',
            'value': <?php echo "$envinstock[5]";?>,
            'color': 'red'
        }, {
            'label':'<?php echo " $envitem[6]";?>',
            'value': <?php echo "$envinstock[6]";?>,
            'color': '#333333'
            
        }, {
           'label':'<?php echo " $envitem[7]";?>',
            'value': <?php echo "$envinstock[7]";?>,
            'color': '#3bafda'
        }]
    }];

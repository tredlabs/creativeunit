...
<script>
		...
		function Create_Receival(validated)
	{
		...
		xhttp.send("Query=Add_price&code="+code+"&unit_cost="+unit_cost+"&sale_cost="+sale_cost+"&name="+name+"&type="+type+"&size="+size);
	...
	*	@return (void)
	*/
	function Remove_price(id) //This is the function to remove the receivals for the Receival Tabel
	{
		//alert("start");
		var xhttp = new XMLHttpRequest();
	...
	*/
	function Update_Receival()
	{
		...
		xhttp.open("POST", "php/Query_Manager.php", true);
		xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		xhttp.send("Query=Update_price&ID="+id+"&code="+code+"&unit_cost="+unit_cost+"&name="+name+"&sale_cost="+sale_cost+"&size="+size);
      ...
      <!-- ========== Left Sidebar Start ========== -->
            ...
            <div class="container">
                <!-- Start content -->
                     <!-- Top Bar End -->
     <center>    
<div id="all" class="blank-page" style="padding-left:0px; padding-top:0px; padding-bottom:0px;">

	</br>	
				<iframe src="adminpanel/panel.php" width="1100px" height="860px" id="frame" align="center"></iframe>

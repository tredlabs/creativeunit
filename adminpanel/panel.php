...
<html>
<head>
<title>Control Panel :: The Creative Unit</title>
...
$sql2="SELECT users_roles.role_id,users_roles.user_email, users.email, users.password, users.username,users.id AS ID
    FROM users 

...
<!-- Custom Theme files -->
                    <title>Office Internal PO</title>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Office Internal PO</h4>
                                </div>
                            </div>
                        </div>
     <div class="card-box" >
...
$db_servername = "localhost";
    ...
    WHERE usage_lineitems.location='Warehouse2'";
			   	 //   
//$conn = new mysqli($db_servername, $db_username, $db_password, $db_name); 
			...
			<div class="form-group">
				<div class="row col-md-12 custyle">
							...
							<div class="input-group">
									...
									<label for="sel1"></label><select class="form-control" id="location" onchange="loc();"><option value='Warehouse2'>Office</option></select>

                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">The Creative Unit Inventory System</h4>
...
<div id="wrapper">
 	...
 	<!--banner-->	
		      ...
		      <div class="banner">
				...
				<a id="full" href="#"> <i class="fa fa-bar-chart"></i> Full Spoilage Report</a> &nbsp &nbsp &nbsp

				

				<a id="date" href="#"> <i class="fa fa-calendar-check-o"></i>  Spoilage Report By Date#</a> &nbsp &nbsp &nbsp

				

				<!--<a id="type" href="#"> <i class="fa fa-files-o"></i>   Spoilage Report By Type</a>&nbsp &nbsp &nbsp
				
				
			<!--	<a id="search" href="#"> <i class="fa fa-files-o"></i>   Spoilage Report Requisition# </a> &nbsp &nbsp &nbsp-->
 	...
 	<div class="blank">
				...
				<form method="GET" action="php/fpdf/spoilagereport.php" target="frame4">
				Location:<select class="form-control" id="location" name="location" onchange="" required>
...
<input type="submit" style="width:100%;" class="btn btn-info" value="Search..." id="typebtn" name="typebtn" onclick="showDiv4()"/>
				...
				<iframe src="" width="1040px" height="1000px" id="frame4" name="frame4"></iframe>
				</div>
				</center>
				</div>
				...
				<form method="GET" action="php/fpdf/spoilbytype.php" target="frame2">
Location:<select class="form-control" id="location" name="location" onchange="" required>
 <option value='' hidden selected>Select</option><option value='Warehouse1'>Printery</option><option value='Warehouse2'>Office</option><option value='Warehouse3'>Events</option></select>
...
<option value="X" hidden>Select One</option>
...
<input type="submit" style="width:100%;" class="btn btn-info" value="Search..." id="typebtn" name="typebtn" onclick="showDiv1()"/>
				...
				<iframe src="" width="1050px" height="1000px" id="frame2" name="frame2"></iframe>
				...
				<form method="GET" action="php/fpdf/searchbytype.php" target="frame3">
Location:<select class="form-control" id="location" name="location" onchange="" required>
 <option value='' hidden selected>Select</option><option value='Warehouse1'>Printery</option><option value='Warehouse2'>Office</option><option value='Warehouse3'>Events</option></select>
...
<br>
				<input type="text" id="req" name="req" class="form-control" placeholder="Requisition #"/>
...
<input type="submit" style="width:100%;" class="btn btn-info" value="Search..." id="typebtn" name="typebtn" onclick="showDiv3()"/>
				...
				<form method="GET" action="php/fpdf/spoilbydate.php" target="frame1">
					Location:<select class="form-control" id="location1" name="location1" onchange="" required>
 <option value='' hidden selected>Select</option><option value='Warehouse1'>Printery</option><option value='Warehouse2'>Office</option><option value='Warehouse3'>Events</option></select>
<br>
				...
				<input type="submit" style="width:100%;" class="btn btn-info" value="Search..." id="datebtn" name="datebtn" onclick="showDiv()"/>
				...
				<div id="myframe">
					...
					<iframe src="" width="1050px" height="1000px" id="frame1" name="frame1"></iframe>
...
<!--scrolling js-->
   ...
   document.getElementById('myframe4').style.display = "block";
	...
	document.getElementById("myframe4").style.display = "none";

...
<script>
	...
	//alert(type);
		...
		xhttp.onreadystatechange = function()
		{
			if(xhttp.readyState == 4)
			{
				if(xhttp.status == 200)
				{
					...
					if (result.match(/Successfully Added*/)||result.match(/New Type Created*/)) {
		...
		xhttp.send("Query=Add_price&code="+code+"&unit_cost="+unit_cost+"&instock="+instock+"&location="+location+"&reorder="+reorder+"&name="+name+"&addtype="+addtype+"&type="+type);
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Events Price Listing</h4>
                                </div>
                            </div>
                        </div>
...
require 'db.php';
	...
	$sql = "SELECT *
	FROM price WHERE location='Warehouse3'";
...
$db_servername = "localhost";
		...
		$db_name =  "dert1_creative_unit";
													...
													$sql = "SELECT id, name FROM events_type";
													$formatted_result="";

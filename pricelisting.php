		...
		<form id="Create_ID" data-toggle="validator" role="form" class="" autocomplete="off">
			<div class="form">
				<div class="row col-md-12 custyle">
				 ...
				 <select class="form-control" id="location" onchange="myFunction1(this.value)">
                  <option value="" hidden selected>Location:</option>
                  <option value='Warehouse1'>Printery</option>
...
?>
    ...
    alert(location);
						...
						<br/>				
							...
							<div id="printery" class="input-group" style="display: none">
										<div class="input-group-addon">
...
$db_servername = "localhost";
		...
		$db_name =  "dert1_creative_unit";
									...
									<br>
										...
										<div id="events" class="input-group" style="display: none">
										<div class="input-group-addon">
											<span class="glyphicon glyphicon-print"></span> 
										</div>
										<!--input type="checkbox" name="Equipment_checkbox" id="Equipment_checkbox" onChange="Allow_Equipment(this.checked);"-->

...
<html>
    <head>
        ...
        <meta name="viewport" content="width=device-width,initial-scale=1">
                    ...
                    <title>Internal PO Reports</title>
...
<div id="wrapper">
 	...
 	<!--banner-->	
		     <div class="banner">
		    	<h4>
				<a id="full" href="#"><i class="fa fa-bar-chart"></i> Internal PO  </a>  &nbsp &nbsp &nbsp
				
	     		<a id="date" href="#"><i class="fa fa-calendar-check-o"></i>Internal PO By Date </a>  &nbsp &nbsp &nbsp
				
			<!--	<a id="type" href="#"> <i class="fa fa-files-o"></i>    Internal PO By Type</a> &nbsp &nbsp &nbsp-->
				
				<a id="search" href="#"> <i class="fa fa-files-o"></i>    Internal PO By #</a>
	...
	<div id="warehouse" class="blank-page">
				...
				<form method="GET" action="php/fpdf/usagereport.php" target="frame">
...
<input type="submit" style="width:100%;" class="btn btn-info" value="Search..." id="typebtn" name="typebtn" onclick="showDiv1()"/>
			...
			<form method="GET" action="php/fpdf/internal.php" target="frame3"autocomplete="off">
<!--Location:<select class="form-control" id="location" name="location" onchange="" required>
                <option value='' hidden selected>Select</option><option value='Warehouse1'>Printery</option><option value='Warehouse2'>Office</option><option value='Warehouse3'>Events</option></select>-->
				<br><input type="number" id="req" name="req" class="form-control" placeholder="PO #"/>
				<br>

...
<!-- Custom Theme files -->
                    <title>Printery Receivals</title>
...
<script>
    ...
    //    var size = document.getElementById(id).value;
		...
		xhttp.send("Query=Add_Recieval&Invoice_Number="+Invoice_Number+"&Recdate="+Recdate+"&location="+location+"&Inline_items="+Inline_items_Sringyfied);
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Printery Receivals</h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="try" class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive"  style="overflow-x:hidden">
                                    ...
                                    <h4 class="m-t-0 header-title"><b>Printery Receivals</b></h4>
...
require 'db.php';
	...
	$sql = "SELECT DISTINCT receivals.*,rec_lineitems.location
	FROM receivals 
	 INNER JOIN rec_lineitems 
	ON rec_lineitems.receival_id=receivals.id
	WHERE rec_lineitems.location='Warehouse1' ";
		...
		<form id="Create_ID" data-toggle="validator" role="form" class=""  autocomplete="off">
			<div class="form">
				<div class="row col-md-12 custyle">
									...
									<label for="sel1"></label><select class="form-control" id="location"><option value='Warehouse1'>Printery</option></select>
									<div class="help-block with-errors"></div>
			...
			<br/>
				<button type="button" class="btn btn-primary" style="border-radius: 10px;" onClick="add_fields();"> <span class="glyphicon glyphicon-plus">&nbsp;Add Item</span></button>
				<br/>
				<br/>
				<center>

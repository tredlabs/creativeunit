		                   ...
		                   // this is the 1st option select 
		              		//This is the input for printedform usageage quantity amount this has 2 input sheet1 and sheet 2	
								 ...
								 +'		<div class="input-group">'
								   ...
								   +'			<input class="form-control" id="otype" name="otype"  type="text" value="office_type" placeholder="Type" required/>'
		...
		new_line_item.innerHTML = ''
		              	 ...
		              	 +'<div class="col-md-2 custyle"  style="display:none">'
								 +'		<div class="input-group">'
								   ...
								   +'			<input class="form-control" id="otype" name="otype"  type="text" value="events_type" placeholder="Type" required/>'

                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Office Stock Listing</h4>
                                </div>
                            </div>
                        </div>
		...
		<!--Adding in page info-->
                        ...
                        <div id="try" class="row" style="display: block">
                            ...
                            <div class="col-sm-12">
                            		...
                            		<h5>
				<a href="price_office.php" onClick="" style="color: #22A7F0;">Price listing</a> &nbsp;&nbsp;&nbsp;&nbsp;
				
	
				</h5>
                               

                                    <h4 class="m-t-0 header-title"><b>Office</b></h4>

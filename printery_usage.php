...
<!-- Custom Theme files -->
                    <title>Printery Internal PO</title>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Printery Internal PO</h4>
                                </div>
                            </div>
                        </div>
     <div class="card-box" >
...
$db_servername = "localhost";
    ...
    WHERE usage_lineitems.location='Warehouse1'";
			   	 //   
//$conn = new mysqli($db_servername, $db_username, $db_password, $db_name); 
			...
			while($row = $result->fetch_assoc())
			{
									...
									{$inv="&nbsp;&nbsp;&nbsp;&nbsp;-";
											...
											<tr id='Listing_row_$id' class='text-black' style='color: #000000;'>
											 <td style='display:block'><b>$id</td>	
			...
			<div class="form-group">
				<div class="row col-md-12 custyle">
							...
							<div class="input-group">
									...
									<label for="sel1"></label><select class="form-control" id="location" onchange="loc();"><option value='Warehouse1'>Printery</option></select>

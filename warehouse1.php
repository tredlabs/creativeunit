                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Printery Stock Listing</h4>
                                </div>
                            </div>
                        </div>
<div class="card-box" style="overflow: hidden">
 	...
 	<div id="Receival_listing" class="blank" style="overflow-y: none;">
		...
		<!--Adding in page info-->
		    	...
		    	<h5>
				<a href="price_printery.php" onClick="" style="color: #22A7F0;">Price listing</a> &nbsp;&nbsp;&nbsp;&nbsp;
				
	
				</h5>
		    </div>

                                    <h4 class="m-t-0 header-title"><b>Printery</b></h4>
...
require 'db.php';
 ...
 $db_servername = "localhost";
	...
	else
	{
		...
		$sql = "SELECT Warehouse1.id, fields.name as type, Warehouse1.name,Warehouse1.updated_at,Warehouse1.instock, Warehouse1.reorderlevel,Warehouse1.cost,Warehouse1.location
		    FROM Warehouse1
			INNER JOIN fields
			ON Warehouse1.field_id=fields.id"; 				

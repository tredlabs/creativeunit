...
<div id="wrapper">
 	...
 	<!--banner-->	
		     <div class="banner">
		    	<h4>
				<a id="full" href="#"><i class="fa fa-bar-chart"></i> Receivals  </a>  &nbsp &nbsp &nbsp
				
				<a id="date" href="#"><i class="fa fa-calendar-check-o"></i>Receival By Date </a>  &nbsp &nbsp &nbsp
				
				<!--<a id="type" href="#"> <i class="fa fa-files-o"></i>    Receival By Type</a> -->
				<a id="search" href="#"> <i class="fa fa-files-o"></i>    Receival By Invoice #</a>
...
<input type="submit" style="width:100%;" class="btn btn-info" value="Search..." id="typebtn" name="typebtn" onclick="showDiv()"/>
				...
				<form method="GET" action="php/fpdf/receivaltype.php" target="frame2">
              ...
              <option value='' hidden selected>Select</option><option value='Warehouse1'>Printery</option><option value='Warehouse2'>Office</option><option value='Warehouse3'>Events</option></select>
				...
				Type:<select class="form-control" id="field" name="field" onchange="">
...
<input type="submit" style="width:100%;" class="btn btn-info" value="Search..." id="typebtn" name="typebtn" onclick="showDiv1()"/>
				...
				<form method="GET" action="php/fpdf/recbydate.php" target="frame1">
			...
			<form method="GET" action="php/fpdf/invreceival.php" target="frame3"autocomplete="off">
<!--Location:<select class="form-control" id="location" name="location" onchange="" required>
                <option value='' hidden selected>Select</option><option value='Warehouse1'>Printery</option><option value='Warehouse2'>Office</option><option value='Warehouse3'>Events</option></select>-->
				<br><input type="text" id="req" name="req" class="form-control" placeholder="Invoice #"/>
				<br>
